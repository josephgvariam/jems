...
public class JemsCounters {
	...
	public static JemsCounters fromJsonToJemsCounters(String json) {
		return new JSONDeserializer<JemsCounters>().use(null,
				JemsCounters.class).deserialize(json);
	}
	...
	public static Collection<JemsCounters> fromJsonArrayToJemsCounterses(
			String json) {
		return new JSONDeserializer<List<JemsCounters>>()
				.use(null, ArrayList.class).use("values", JemsCounters.class)
				.deserialize(json);
	}
}
