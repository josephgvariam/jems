...
public class JemsQuotation {
	...
	public static com.dubaidrums.jems.domain.JemsQuotation fromJsonToJemsQuotation(
			String json) {
		return new JSONDeserializer<JemsQuotation>().use(null,
				JemsQuotation.class).deserialize(json);
	}

	public static String toJsonArray(
			Collection<com.dubaidrums.jems.domain.JemsQuotation> collection) {
		return new JSONSerializer().exclude("*.class").serialize(collection);
	}

	public static Collection<com.dubaidrums.jems.domain.JemsQuotation> fromJsonArrayToJemsQuotations(
			String json) {
		return new JSONDeserializer<List<JemsQuotation>>()
				.use(null, ArrayList.class).use("values", JemsQuotation.class)
				.deserialize(json);
	}
	...
	public boolean equals(Object obj) {
		...
		if (id == null) {
			...
			return false;
		if (qNumber == null) {
			if (other.qNumber != null)
				return false;
		} else if (!qNumber.equals(other.qNumber))
			return false;
		return true;
	}
