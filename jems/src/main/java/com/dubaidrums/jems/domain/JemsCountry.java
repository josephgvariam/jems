...
public class JemsCountry{
	...
	public static JemsCountry fromJsonToJemsCountry(String json) {
        return new JSONDeserializer<JemsCountry>().use(null, JemsCountry.class).deserialize(json);
    }
	...
	public static Collection<JemsCountry> fromJsonArrayToJemsCountrys(String json) {
        return new JSONDeserializer<List<JemsCountry>>().use(null, ArrayList.class).use("values", JemsCountry.class).deserialize(json);
    }
