...
public class JemsTax {
	...
	public static JemsTax fromJsonToJemsTax(String json) {
        return new JSONDeserializer<JemsTax>().use(null, JemsTax.class).deserialize(json);
    }
	...
	public static Collection<JemsTax> fromJsonArrayToJemsTaxes(String json) {
        return new JSONDeserializer<List<JemsTax>>().use(null, ArrayList.class).use("values", JemsTax.class).deserialize(json);
    }
}
