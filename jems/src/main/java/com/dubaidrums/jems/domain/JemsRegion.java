...
public class JemsRegion {
	...
	public static JemsRegion fromJsonToJemsRegion(String json) {
        return new JSONDeserializer<JemsRegion>().use(null, JemsRegion.class).deserialize(json);
    }
	...
	public static Collection<JemsRegion> fromJsonArrayToJemsRegions(String json) {
        return new JSONDeserializer<List<JemsRegion>>().use(null, ArrayList.class).use("values", JemsRegion.class).deserialize(json);
    }
