...
public class JemsRole {
	...
	public static JemsRole fromJsonToJemsRole(String json) {
		return new JSONDeserializer<JemsRole>().use(null, JemsRole.class)
				.deserialize(json);
	}
	...
	public static Collection<JemsRole> fromJsonArrayToJemsRoles(String json) {
		return new JSONDeserializer<List<JemsRole>>()
				.use(null, ArrayList.class).use("values", JemsRole.class)
				.deserialize(json);
	}
}
