...
public class CheckboxesTag extends AbstractCheckedElementTag {
	 ...
	 * objects used to generate the '{@code input type="checkbox/radio"}' tags.
	 */
	...
	/**
	 * The HTML element used to enclose the '{@code input type="checkbox/radio"}
	 * ' tag.
	 */
	...
	/**
	 * Get the {@link java.util.Collection}, {@link java.util.Map} or array of
	 * objects used to generate the '{@code input type="checkbox/radio"}' tags.
	 */
	...
	/**
	 * Set the name of the property mapped to the '{@code value}' attribute of
	 * the '{@code input type="checkbox/radio"}' tag.
	 * <p>
	...
	/**
	 * Get the name of the property mapped to the '{@code value}' attribute of
	 * the '{@code input type="checkbox/radio"}' tag.
	 */
	...
	/**
	 * Return the delimiter to be used between each '{@code input type="radio"}'
	 * tag.
	 */
	...
	/**
	 * Get the HTML element used to enclose '{@code input type="checkbox/radio"}
	 * ' tag.
	 */
	...
	/**
	 * Appends a counter to a specified id as well, since we're dealing with
	...
	protected String resolveId() throws JspException {
		...
		if (id != null) {
			...
			return (StringUtils.hasText(idString) ? TagIdGenerator.nextId(
					idString, this.pageContext) : null);
		}
	...
	protected int super_writeTagContent(TagWriter tagWriter)
			throws JspException {
	...
	protected int writeTagContent(TagWriter tagWriter) throws JspException {
		super_writeTagContent(tagWriter);
