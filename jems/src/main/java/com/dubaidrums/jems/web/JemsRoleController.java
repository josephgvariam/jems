...
public class JemsRoleController {
    ...
    public ResponseEntity<String> showJson(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<String>(jemsRole.toJson(), headers, HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> listJson() {
        ...
        return new ResponseEntity<String>(JemsRole.toJsonArray(result), headers, HttpStatus.OK);
    }
    ...
    public String create(@Valid JemsRole jemsRole, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        jemsRoleService.saveJemsRole(jemsRole);
        return "redirect:/jemsroles/" + encodeUrlPathSegment(jemsRole.getId().toString(), httpServletRequest);
    }
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("jemsroles", jemsRoleService.findJemsRoleEntries(firstResult, sizeNo));
            float nrOfPages = (float) jemsRoleService.countAllJemsRoles() / sizeNo;
    ...
    public String update(@Valid JemsRole jemsRole, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, jemsRole);
