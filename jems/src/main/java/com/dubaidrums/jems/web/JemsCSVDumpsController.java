...
public class JemsCSVDumpsController {
	...
	@Autowired
	JemsCsvDumpService jemsCsvDumpService;
	...
	@ResponseBody
	public ResponseEntity<String> dumpCsv(
			@RequestParam(value = "searchdate", required = true) boolean searchDate,
			@RequestParam(value = "startDate", required = true) String startDate,
			@RequestParam(value = "endDate", required = true) String endDate,
			Principal principal, HttpServletRequest r,
			HttpServletResponse response) {
		try {
			String filename = jemsCsvDumpService.dumpCsv(searchDate, startDate,
					endDate, r);
			if (filename.startsWith("ERROR"))
				throw new Exception("Error occurred while dumping csv: "
						+ filename);
			...
			return new ResponseEntity<String>(ex.getMessage(), headers,
					HttpStatus.OK);
		}
	...
	// produces = "text/csv")
	// @ResponseBody
	// public ResponseEntity<String> getQuotationCSVDump(@RequestParam(value =
	// "searchdate", required = true) boolean searchDate, @RequestParam(value =
	// "startDate", required = true) String startDate, @RequestParam(value =
	// "endDate", required = true) String endDate, Principal
	// principal,HttpServletRequest r) {
	// try{
	//
	//
	...
	// StringBuilder("Quotation Date,Event Date,Quote No,Organisation,Event Type,Event Description,No of Facilitators,No of People,Company Name,Contact Person,Contact Number,Email ID,Status,Invoice No,Quoted Amt,Invoiced Amt,Paid Status\n");
	...
	// }
	//
	// private String getLineItemString(JemsEvent e, JemsQuotation q,
	// JemsInvoice i,HttpServletRequest r){
	// StringBuilder s = new StringBuilder();
	//
	// if(checkOption("edate",r)){
