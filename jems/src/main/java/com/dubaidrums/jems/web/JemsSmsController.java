...
public class JemsSmsController {
    ...
    public ResponseEntity<String> showJson(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<String>(jemsSms.toJson(), headers, HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> listJson() {
        ...
        return new ResponseEntity<String>(JemsSms.toJsonArray(result), headers, HttpStatus.OK);
    }
    ...
    public String create(@Valid JemsSms jemsSms, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        jemsSmsService.saveJemsSms(jemsSms);
        return "redirect:/jemssmses/" + encodeUrlPathSegment(jemsSms.getId().toString(), httpServletRequest);
    }
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("jemssmses", jemsSmsService.findJemsSmsEntries(firstResult, sizeNo));
            float nrOfPages = (float) jemsSmsService.countAllJemsSmses() / sizeNo;
    ...
    public String update(@Valid JemsSms jemsSms, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, jemsSms);
	...
	void addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("jemsSms_senttime_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
    }
