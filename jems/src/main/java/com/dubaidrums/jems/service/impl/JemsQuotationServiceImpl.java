...
public class JemsQuotationServiceImpl implements JemsQuotationService {
	...
	public List<JemsQuotation> findJemsQuotationEntries(int firstResult,
			int maxResults) {
		return jemsQuotationRepository.findAll(
	...
	// public void saveJemsQuotation(JemsQuotation jemsQuotation, Long
	// jemsEventId) {
	...
	public synchronized void saveNewJemsQuotation(JemsQuotation jemsQuotation) {
		jemsQuotation.setQNumber(jemsCountersService
				.nextQuotaionNumber(jemsQuotation.getJemsEvent()
						.getOrganization()));
		jemsQuotationRepository.save(jemsQuotation);
