...
public interface JemsInvoiceService {
	...
	public abstract List<JemsInvoice> findJemsInvoiceEntries(int firstResult, int maxResults);


	//public abstract void saveJemsInvoice(JemsInvoice jemsInvoice, Long jemsEventId);
