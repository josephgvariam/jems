...
public class JemsCountersServiceImpl implements JemsCountersService {
	...
	public List<JemsCounters> findJemsCountersEntries(int firstResult, int maxResults) {
        return jemsCountersRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    }
	...
	public Integer nextQuotaionNumber(JemsOrganization organization) {
		JemsCounters jc = jemsCountersRepository.findByOrganization(organization);
