...
public interface JemsQuotationService {
	...
	public abstract List<JemsQuotation> findJemsQuotationEntries(
			int firstResult, int maxResults);

	// public abstract void saveJemsQuotation(JemsQuotation jemsQuotation, Long
	// jemsEventId);

	public abstract JemsQuotation updateJemsQuotation(
