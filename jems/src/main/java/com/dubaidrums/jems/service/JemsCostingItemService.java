...
public interface JemsCostingItemService {
	...
	public abstract List<JemsCostingItem> findJemsCostingItemEntries(int firstResult, int maxResults);


	public abstract void saveJemsCostingItem(JemsCostingItem jemsCostingItem);


	public abstract JemsCostingItem updateJemsCostingItem(JemsCostingItem jemsCostingItem);
