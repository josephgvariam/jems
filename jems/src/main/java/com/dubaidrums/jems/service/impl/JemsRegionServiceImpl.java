...
public class JemsRegionServiceImpl implements JemsRegionService {
	...
	public List<JemsRegion> findJemsRegionEntries(int firstResult, int maxResults) {
        return jemsRegionRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    }
