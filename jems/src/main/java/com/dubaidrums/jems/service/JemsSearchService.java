...
public interface JemsSearchService {
	...
	public String query(String q, boolean chkdates, boolean chkpaid, boolean chktype, boolean chkeventstatus, Date startdatetime, Date enddatetime, boolean paidstatus, String eventtype, String eventstatus, JemsUser user);
}
