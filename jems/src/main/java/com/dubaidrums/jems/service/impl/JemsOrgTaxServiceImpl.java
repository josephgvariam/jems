...
public class JemsOrgTaxServiceImpl implements JemsOrgTaxService {
	...
	public List<JemsOrgTax> findJemsOrgTaxEntries(int firstResult, int maxResults) {
        return jemsOrgTaxRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    }
