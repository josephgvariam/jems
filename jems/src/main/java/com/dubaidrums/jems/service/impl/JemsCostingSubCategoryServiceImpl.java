...
@Service
@Transactional
public class JemsCostingSubCategoryServiceImpl implements
	...
	public void deleteJemsCostingSubCategory(
	...
	public List<JemsCostingSubCategory> findJemsCostingSubCategoryEntries(
	...
	public void saveJemsCostingSubCategory(
			JemsCostingSubCategory jemsCostingSubCategory) {
		jemsCostingSubCategoryRepository.save(jemsCostingSubCategory);
	}

	public JemsCostingSubCategory updateJemsCostingSubCategory(
			JemsCostingSubCategory jemsCostingSubCategory) {
		return jemsCostingSubCategoryRepository.save(jemsCostingSubCategory);
	}

	@Override
	public List<JemsCostingSubCategory> findAllJemsCostingSubCategorysByCategoryId(
			Long cid) {
