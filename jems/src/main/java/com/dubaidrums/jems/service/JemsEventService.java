...
public interface JemsEventService {
	...
	// public abstract List<JemsEvent> findJemsEventEntries(int firstResult, int
	// maxResults);
	public abstract Page<JemsEvent> findJemsEventEntries(JemsUser user,
	...
	public abstract List<JemsEvent> getCalendarEventsList(String selectedDate,
			JemsUser user);
	...
	public abstract List<JemsEvent> findByStartDateTimeBetweenAndOrganizationIn(
			Date start, Date end, Set<JemsOrganization> orgs);

	public abstract List<JemsEvent> findByStartDateTimeBetweenAndOrganizationId(
			Date start, Date end, Long orgId);

	public void generateRepeatEvents(String params, JemsEvent jemsEvent);

	public abstract Map<String, List> getReportData(String startDate,
			String endDate, String type, Long org, JemsUser user);
