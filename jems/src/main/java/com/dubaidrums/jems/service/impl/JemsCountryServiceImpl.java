...
public class JemsCountryServiceImpl implements JemsCountryService {
	...
	public List<JemsCountry> findJemsCountryEntries(int firstResult, int maxResults) {
        return jemsCountryRepository.findAll(new org.springframework.data.domain.PageRequest(firstResult / maxResults, maxResults)).getContent();
    }
